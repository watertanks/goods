  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide"> 
         <figure>
         <img src = "/img/originalArtist/bts.jpg" width=600px height=600px>
         <figcaption class="contents">
            ...
            <div class="go_artist">
               <p style="background-color:#6495ED"><a href="/pl?page=1&ac=BT&orderby=a&schtype=nkey=">바로가기</a></p>
            </div>
         </figcaption>
         </figure>
      </div>
      <div class="swiper-slide">
         <figure>
         <img src = "/img/originalArtist/blackpink.jpg" width=600px height=600px>
         <figcaption class="contents">
            ...
            <div class="go_artist">
               <p style="background-color:#FFB6C1"><a href=/pl?page=1&ac=BP&orderby=a&schtype=nkey=>바로가기</a></p>
            </div>
         </figcaption>
         </figure>
      </div>
      <div class="swiper-slide">
         <figure>
         <img src = "/img/originalArtist/bss.jpg" width=600px height=600px>
         <figcaption class="contents">
            <span>NEW</span>
            <h1>SEVENTEEN</h1>
            ...
            <div class="go_artist">
               <p style="background-color:#B0E0E6"><a href=/pl?page=1&ac=ST&orderby=a&schtype=nkey=>바로가기</a></p>
            </div>
         </figcaption>
         </figure>
      </div>
      <div class="swiper-slide">
         <figure><img src = "/img/originalArtist/mainive.jpg" width=600px height=600px>
         <figcaption class="contents">
            <span>신인 BEST</span>
            <h1>IVE</h1>
            ...
            <div class="go_artist">
               <p style="background-color:#DA70D6"><a href=/pl?page=1&ac=IV&orderby=a&schtype=nkey=>바로가기</a></p>
            </div>
         </figcaption>
      ...
      <div class="swiper-slide">
         <figure><img src = "/img/originalArtist/idelmain.jpg" width=600px height=600px>
         <figcaption class="contents">
            <span>RESTOCK</span>
            <h1>(G)idle</h1>
            ...
            <div class="go_artist">
               <p style="background-color:#FFE4B5"><a href=/pl?page=1&ac=ID&orderby=a&schtype=nkey=>바로가기</a></p>
            </div>
         </figcaption>
         </figure>
      </div>
   ...
   <div class="artist">
      ...
      <div class="artist-best">
          ...
          <div class="artname"> <p>BTS</p></div>
             <img src="/img/originalArtist/bts2.jpg" />
          
             
          </a>
      </div>
      <div class="artist-mid">
          <div><a href=""><img src="/img/originalArtist/newjeans.jpg"><p>뉴진스</p></a></div>
          <div><a href=""><img src="/img/originalArtist/blackpink.jpg"><p>블랙핑크</p></a></div>
          <div><a href=""><img src="/img/originalArtist/seventeen.jpg"><p>세븐틴</p></a></div>
      </div>
   </div>
   <div class="album">
       <h2>앨범판매 베스트</h2>
       <div class="album-best" >
           <a href="#">
                 <div class="artname"><p>아이브</p></div>
                     <img src="/img/originalArtist/ive2.jpg" />
       ...
       <div class="album-mid">
           <div><a href=""><img src="/img/originalArtist/bts.jpg"><p>BTS</p></a></div>
               <div><a href=""><img src="/img/originalArtist/newjeans.jpg"><p>뉴진스</p></a></div>
           <div><a href=""><img src="/img/originalArtist/ive2.jpg"></a><p>아이브</p></a></div>
       </div>
   </div>
   <div class="product">
       <h2>상품판매 베스트</h2>
       <div class="product-best">
           ...
           <div class="artname"><p>뉴진스</p></div>
               <img src="/img/originalArtist/newjeans2.jpg" />
       ...
       <div class="product-mid">
           <div><a href=""><img src="/img/originalArtist/blackpink.jpg"><p>블랙핑크</p></a></div>
           <div><a href=""><img src="/img/originalArtist/ive2.jpg"></a><p>아이브</p></a></div>
           <div><a href=""><img src="/img/originalArtist/shinee.jpg"><p>샤이니</p></a></div>
       </div>
   </div>
</article>
   ...
   <div class="new-Wrap">
      ...
      <div class="md-product">
          <div>
              <a href="" style="">
               <div>
                   <img src="/img/product/jiminalbum.jpg" >
               </div>
               <div>
         ...
         <div>
             <a href="" style="">
                 <div>
                     <img src="/img/product/idelbong.jpg" >
                 </div>
                 <div>
         ...
         <div>
             <a href="" style="">
                 <div>
                    <img src="/img/product/yenaablum.jpg" >
                 </div>
                 <div>
