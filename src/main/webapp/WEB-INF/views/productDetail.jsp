...
ArrayList<ProductStock> stockList = (ArrayList<ProductStock>) request.getAttribute("ps");
...
<div class="wrapper">
	<div class="pdt_detail">
		...
		<ol>
			<li><img src="/img/product/<%=pi.getPi_img1()%>"></li>
		...
		<figure>
			...
			<img src="/img/product/<%=pi.getPi_desc()%>">
		</figure>
	</div>
