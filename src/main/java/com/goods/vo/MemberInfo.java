...
public class MemberInfo {
	...
	private String mi_joindate;
	private String mi_status;
	private String mi_kind;
	
	private int mi_point;
	private int mi_bmcount;
	private int mi_couponcount;
	...
	public String getMi_kind() {
		return mi_kind;
	}
	public void setMi_kind(String mi_kind) {
		this.mi_kind = mi_kind;
	}
	...
	public String toString() {
		return "MemberInfo [mi_id=" + mi_id + ", mi_pw=" + mi_pw + ", mi_gender=" + mi_gender + ", mi_birth=" + mi_birth
				+ ", mi_name=" + mi_name + ", mi_nickname=" + mi_nickname + ", mi_email=" + mi_email + ", mi_phone="
				+ mi_phone + ", mi_lastlogin=" + mi_lastlogin + ", mi_joindate=" + mi_joindate + ", mi_status="
				+ mi_status + ", mi_kind=" + mi_kind + ", mi_point=" + mi_point + ", mi_bmcount=" + mi_bmcount
				+ ", mi_couponcount=" + mi_couponcount + "]";
	}
